...
export function DeliverableItemRow({ item, onDownload }: DeliverableItemRowProps) {
  return (
    <div className="group flex flex-col gap-3 rounded-2xl border-edge/50 bg-surface-elevated p-4 transition hover:border-accent/40 sm:flex-row sm:items-center sm:justify-between">
