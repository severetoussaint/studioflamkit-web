...
import { Clock, FolderOpen, UploadCloud } from 'lucide-react';
      ...
      <div className="w-full sm:max-w-xl">
        ...
        <div className="mt-3 relative inline-block text-left w-full">
          ...
          >
            ...
            <span className="text-xs text-ink-muted/80 transition-transform duration-200 group-hover:translate-y-0.5 shrink-0">
              ▼
            </span>
          </button>
