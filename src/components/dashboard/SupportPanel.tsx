...
export function SupportPanel({
  ...
  return (
    <div className="relative overflow-hidden rounded-3xl border-edge/50 bg-surface-elevated/90 p-6 sm:p-8 shadow-[0_12px_40px_rgba(0,0,0,0.02)] backdrop-blur-xs transition-all duration-300 hover:-translate-y-0.5 hover:border-accent/20 hover:shadow-[0_16px_48px_rgba(0,0,0,0.035)]">
      ...
      <div className="relative z-10 mb-5 flex items-start justify-between gap-4 border-b border-edge/40 pb-5">
        <div className="flex items-start gap-3.5">
          <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full border-accent/15 bg-accent/5 text-accent shadow-[0_8px_24px_rgba(242,107,46,0.08)]">
        ...
        <span className="hidden sm:inline-flex items-center gap-1.5 rounded-full border-emerald-500/20 bg-emerald-500/8 px-3 py-1 text-[10px] font-medium uppercase tracking-[0.16em] text-emerald-800 dark:text-emerald-300">
      ...
      <div className="relative z-10 space-y-4 text-sm">
        <div className="rounded-2xl border-edge/60 bg-surface/60 p-4 sm:p-4.5">
        ...
        <div className="grid gap-2.5 sm:grid-cols-2 text-xs font-light text-ink-muted/80">
          <div className="flex items-center gap-2 rounded-2xl border-edge/50 bg-surface/50 p-3">
