    ...
    >
      ...
      <div className="relative flex items-center justify-center w-64 h-64">
        ...
        {ripples.map((delay, index) => (
          <motion.div
            key={index}
            className="absolute rounded-full border-accent/20 bg-accent/[0.01]"
        ...
        <motion.div 
          className="relative flex items-center justify-center w-16 h-16 rounded-full bg-surface-elevated border-edge shadow-lg shadow-black/5 z-10"
          animate={{
            scale: [1, 1.08, 1],
            boxShadow: [
