...
export function Card({ children, className = '', title, description }: CardProps) {
  return (
    <div
      className={`rounded-3xl border border-edge bg-surface-elevated p-6 shadow-[0_0_0_1px_rgba(150,114,61,0.06),0_12px_40px_rgba(0,0,0,0.05)] backdrop-blur ${className}`.trim()}
    >
