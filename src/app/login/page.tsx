            ...
            >
              <Card className="relative border-edge/50 bg-surface-elevated/60 shadow-xl backdrop-blur-md p-8 sm:p-10 rounded-3xl">
                ...
                <div className="mb-8 flex items-center justify-between">
                  <span className="inline-flex items-center gap-1.5 rounded-full border-accent/30 bg-accent/10 px-3.5 py-1 text-xs font-medium uppercase tracking-[0.25em] text-accent">
                    <Sparkles className="h-3.5 w-3.5" />
                    Acceso Autor
                  </span>
                  <div className="flex h-10 w-10 items-center justify-center rounded-2xl border-edge/50 bg-surface text-accent shadow-inner">
                ...
                {error ? (
                  <motion.div
                    ...
                    className="mb-5 rounded-2xl bg-rose-500/10 border-rose-500/30 p-4 text-xs text-rose-600 dark:text-rose-400 font-medium"
                  >
                    {error}
                  </motion.div>
                ) : null}
                ...
                {/* Trust Badge */}
                <div className="mt-6 flex items-center justify-center gap-2 rounded-2xl bg-surface/50 border-edge/40 px-4 py-2.5 text-[11px] text-ink-muted">
